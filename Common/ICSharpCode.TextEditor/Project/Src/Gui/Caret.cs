...
namespace ICSharpCode.TextEditor
{
	...
	public class Caret : System.IDisposable
	{
		...
		{
            Debug.WriteLine("Caret.OnPositionChanged() {");
			if (this.textArea.MotherTextEditorControl.IsInUpdate) {
                ...
                Debug.WriteLine("this.textArea.MotherTextEditorControl.IsInUpdate == true");
                Debug.WriteLine("Caret.OnPositionChanged() }");
                return;
			...
			if (PositionChanged != null) {
                ...
                Debug.WriteLine("PositionChanged event raised");
            }
