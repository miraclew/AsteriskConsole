...
namespace Asterisk.NET
{
	public static class Common
	{
		...
		public const int DEFAULT_RECONNECT_RETRY_FAST = 5;
		/// <summary> Default Maximum Reconnect retry counter.</summary>
		public const int DEFAULT_RECONNECT_RETRY_MAX = 10;
		/// <summary> Default Fast Reconnect interval in milliseconds.</summary>
		public const int DEFAULT_RECONNECT_INTERVAL_FAST = 5000;
		/// <summary> Default Slow Reconnect interval in milliseconds.</summary>
		public const int DEFAULT_RECONNECT_INTERVAL_SLOW = 10000;
